...
def menu() -> None:
    print('=========================================')
    print('====== Mercadinho do Rafael =============')
    print('==== Tudo o que você precisa!! ==========')
    print('=========================================')
...
def comprar_produto() -> None:
    if len(produtos) > 0:
        ...
        print('Ainda não existem produtos disponiveis.')
    sleep(2)
    menu()
...
def visualizar_carrinho() -> None:
    if len(carrinho) > 0:
       ...
       for item in carrinho:
        ...
        print('Não foi encontrado nenhum produto no carrinho.')
    sleep(2)
    menu()
